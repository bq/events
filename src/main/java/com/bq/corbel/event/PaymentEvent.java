...
public class PaymentEvent extends EventWithSpecificDomain {
    ...
    public enum Type {
        NEW_PAYMENT_PLAN, SUCCESS_RECURRING_PAYMENT, SUCCESS_PAYMENT, RECURRING_PAYMENT_FAILURE, PAYMENT_PLAN_TERMINATED,
        PAYMENT_METHOD_UPDATE_IN_PAYMENT_PLAN, PRICE_UPDATE_IN_PAYMENT_PLAN
    }
